            ...
            <div class="main-slide block-slider">
                <ul class="biolife-carousel nav-none-on-mobile" data-slick='{"arrows": true, "dots": false, "slidesMargin": 0, "slidesToShow": 1, "infinite": true, "speed": 800}' >
                    <li>
                        <div class="slide-contain slider-opt03__layout01">
                            <div class="media">
                                <div>
                                    <a href="#" class="link-to">
                                        <img src="assets/images/categorias.png" width="604" height="580" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <li>
                        <div class="slide-contain slider-opt03__layout01">
                            <div class="media">
                                <div class="child-elememt"><a href="#" class="link-to"><img src="assets/images" width="604" height="580" alt=""></a></div>
                            </div>
                            <div class="text-content">
                                <i class="first-line">Hola bienvenido a mi marketplace</i>
                                <h3 class="second-line">Productos 100% calidosos</h3>
                                <p class="third-line">Ven y compra en nuestras diferentes categorias</p>
            ...
            <div class="product-tab z-index-20 sm-margin-top-193px xs-margin-top-30px">
                <div class="container">
                    <div class="biolife-title-box">
                        <h3 class="main-title">Holi estás son nuestras categorias</h3>
                    </div>
                    <div class="biolife-tab biolife-tab-contain sm-margin-top-34px">
                            ...
                            <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                               ...
                               @foreach($categorias as $key => $categoria)
                                 <li class="tab-element {{ $key == 0 ? 'active' : '' }}">
                                     <a href="#tab{{$categoria->slug}}" class="tab-link">{{$categoria->nombre}}</a>
                                 </li>
                               @endforeach  
                            </ul>
                        </div>
                        <div class="tab-content">
                            @foreach($categorias as $key => $categoria)
                                ...
                                <div id="tab{{ $categoria->slug }}" class="tab-contain {{ $key == 0 ? 'active' : '' }}">
                                                    ...
                                                    <div class="contain-product layout-default">
                                                        <div class="product-thumb">
                                                            <a href="#" class="link-to-product">
                                                                ...
                                                                <img src="{{url('img/productos/'.$producto->imagen)}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                                @else
                                                                    <img src="{{url('img/productos/defecto.png')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                                @endif
                                                            </a>
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <h4 class="product-title"><a href="#" class="pr-name">{{ $producto->nombre }}</a></h4>
                                                            <div class="price ">{{ $producto->valor }}
                                                                <ins><span class="price-amount"><span class="currencySymbol"> {{ $producto ->valor }}</span></ins>
                                                            </div>
